        ...
        <nav class="l-header-nav">
          <ul class="l-header-nav__list">
            <li class="l-header-nav__item">
              <a href="https://www.facebook.com/katsuhiro.kakoi/" class="l-header-nav__link">
                <i class="fab fa-facebook icon facebook"></i>
              </a>
            </li>
            <li class="l-header-nav__item">
              <a href="https://twitter.com/KatsuhiroKakoi" class="l-header-nav__link">
                <i class="fab fa-twitter icon twitter"></i>
              </a>
            </li>
            <li class="l-header-nav__item">
              <a href="https://www.instagram.com/katsucode/" class="l-header-nav__link">
            ...
            <li class="l-header-nav__item">
              <a href="<?php echo esc_url(home_url('recruit')); ?>" class="l-header-nav__link">メンバー募集</a>
            </li>
          </ul>
        </nav>
      ...
      <?php if (is_front_page()) : ?>
        ...
        <div class="p-index">
          ...
          <div class="p-index__visual">
            <h2 class="p-index__visual-catch">Welcome to <span>Katsu code.</span></h2>
            ...
            <div class="scrolldown">
              <div class="scrolldown-box">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 144 206.98" class="scroll-icon">
                  <g id="Layer_2" data-name="Layer 2">
                    <g id="Layer_1-2" data-name="Layer 1">
                      <path d="M141.54,129.23a8.6,8.6,0,0,1,0,12L78,204.52a8.6,8.6,0,0,1-12,0L2.46,141.28a8.6,8.6,0,0,1,0-12,8.6,8.6,0,0,1,12,0l49,49V8.49a8.49,8.49,0,1,1,17,0V178.24l49-49a8.59,8.59,0,0,1,12,0Z" />
                    </g>
                  </g>
                </svg>
              </div>
        ...
        <?php else : ?>
          ...
          <div class="p-page">
            ...
            <div class="p-page__visual">
              <h2 class="c-title__page-primary p-page__title">
                <div class="c-title__page-primary--wrapper">
                  <div class="c-title__page-primary--wrapper-ja">
                    <?php echo get_main_title(); ?>
                  </div>
                  <div class="c-title__page-primary--wrapper-en">
                    <span>
                      <?php echo CFS()->get('title_en'); ?>
                    </span>
                  </div>
                </div>
              </h2>
              <div class="p-page__visual-image">
